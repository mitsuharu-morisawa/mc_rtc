 ...
 * using the DCMStabilizer
 *
 * This state allows to:
 * - Move the CoM to a desired position using the DCMStabilizer
 ...
 *
 *  \see mc_tasks::lipm_stabilizer::DCMStabilizerTask
 */
struct DCMStabilizerStandingState : State
{
...
protected:
  std::shared_ptr<mc_tasks::lipm_stabilizer::DCMStabilizerTask> stabilizerTask_ = nullptr;
